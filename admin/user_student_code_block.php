...
if(isset($_POST['block_student'])) {
    ...
    if($query_run) {
        ...
        $_SESSION['status_code'] = "success";
        header("Location: user_student_block.php");
        exit(0);
    } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['edit_last_name'], $_POST['edit_student_id_no'], $_POST['edit_first_name'], $_POST['gender'], $_POST['year_level'], $_POST['course'])) {
