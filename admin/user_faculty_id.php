...
<div id="bg">
    <div id="id">
            ...
            <div>
                <p style="font-size:13px;font-weight:bold;color:black;text-align:center;font-family:Georgia,serif;position:absolute;left:0;right:0;bottom:-15px;letter-spacing:2px;"><?php echo $course; ?></p>
            </div>
    </div>

    <div class="id-1">
        <p class="text-end" style="font-size:7px;margin-top:2px;margin-right:3px;font-weight:bold;">Birthdate: <?php echo date('F j, Y', strtotime($bdate)); ?></p>
        <br>
        <br>
        <center>
