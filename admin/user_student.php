                    ...
                    <div class="card">
                         ...
                         <div class="card-body">
                              ...
                              <table id="example" class="display nowrap" style="width:100%">
                                        ...
                                        <tbody>
                                             <?php
                                             $query = "SELECT * FROM user WHERE status IN ('approved') AND role_as = 'student' ORDER BY user_id ASC";
                                                            ...
                                                            <!-- <td>
                                                                 <center>
                                                                      ...
                                                                      <img src="../uploads/profile_images/<?php echo $user['profile_image']; ?>"
                                                                           alt="image" width="90px" height="70px">
                                                                      <?php else: ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editStudentModalLabel">Edit Students</h5>
