            ...
            <center>
                <?php      
                    if ($profile != "") {
                        ...
                        echo "<img src='../uploads/profile_images/$profile' alt='' style='border: 2px solid #1076c1; width: 1.2in; height: 1.2in;overflow:hidden;position:absolute;left:0;right:0;top:70px;display:block;margin:0 auto;'>";
                        } else {
