...
<div id="bg">
    <div id="id">
        <br>
            ...
            <center>
                <?php      
                    if ($profile != "") {
                        ...
                        echo "<img src='../uploads/profile_images/$profile' alt='' style='border: 4px solid #1076c1; width: 1.2in; height: 1.2in;overflow:hidden;position:absolute;left:0;right:0;top:70px;display:block;margin:0 auto;'>";
                        } else {
            ...
            <div>
                <p style="font-size:27px;font-weight:bold;color:black;text-align:center;font-family:Georgia,serif;position:absolute;top:20px;left:0;right:0;bottom:0;letter-spacing:2px;"><?php echo $course; ?></p>
            </div>
    </div>
