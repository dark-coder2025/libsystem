                    ...
                    <div class="card">
                         ...
                         <div class="card-body">
                              ...
                              <table id="example" class="display nowrap" style="width:100%">
                                        ...
                                        <tbody>
                                             <?php
                                             $query = "SELECT * FROM faculty WHERE status IN ('blocked') AND (role_as = 'faculty' OR role_as = 'staff') ORDER BY faculty_id ASC";
      ...
      <div class="modal-body">
        <form id="editFacultyForm" method="POST" action="user_faculty_code.php">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="editStaff" name="edit_staff" style="text-transform:capitalize;">
          </div>
...
function loadFacultyData(faculty_id) {
    fetch('user_faculty_code.php?id=' + faculty_id)
        ...
        .then(data => {
            ...
            document.getElementById('editStaff').value = data.course;
