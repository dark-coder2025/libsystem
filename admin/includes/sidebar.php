...
<aside id="sidebar" class="sidebar" id="v-pills-tab" role="tablist">
     ...
     <ul class="sidebar-nav" id="sidebar-nav">
          <li class="nav-item">
               <a class="nav-link collapsed<?=$page == 'index.php'  ? 'active': '' ?>" 
                    href=".">
          ...
          <li class="nav-item">
               <a class="nav-link collapsed<?=$page == 'users_block.php' || $page == 'user_student_block.php' || $page == 'user_faculty_block.php'  ? 'active': '' ?>"
